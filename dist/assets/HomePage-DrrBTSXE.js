...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function Eo(){return new Ln({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:wa(),fragmentShader:`
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function yo(){return new Ln({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wa(),fragmentShader:`
...
`)}function Lp(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Bi(i){return i!==""}function Io(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function No(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Up=/^[ \t]*#include +<([\w\d./]+)>/gm;function oa(i){return i.replace(Up,Np)}const Ip=new Map;function Np(i,e){let t=We[e];if(t===void 0){const n=Ip.get(e);if(n!==void 0)t=We[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return oa(t)}const Fp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Fo(i){return i.replace(Fp,Op)}function Op(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Oo(i){let e=`precision ${i.precision} float;
...
`].filter(Bi).join(`
`)),o=oa(o),o=Io(o,t),o=No(o,t),a=oa(a),a=Io(a,t),a=No(a,t),o=Fo(o),a=Fo(a),t.isRawShaderMaterial!==!0&&(R=`#version 300 es
...
`)+`
`+u);const b=R+m+o,T=R+u+a,U=Do(r,r.VERTEX_SHADER,b),A=Do(r,r.FRAGMENT_SHADER,T);r.attachShader(M,U),r.attachShader(M,A),t.index0AttributeName!==void 0?r.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function w(C){if(i.debug.checkShaderErrors){const W=r.getProgramInfoLog(M).trim(),z=r.getShaderInfoLog(U).trim(),O=r.getShaderInfoLog(A).trim();let $=!0,Y=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,M,U,A);else{const ne=Uo(r,U,"vertex"),V=Uo(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `);X.fragmentShader=X.fragmentShader.replace("#include <lights_fragment_begin>",ie),this.onBeforeCompile2&&this.onBeforeCompile2(X)}}}const a={count:200,colors:[0,0,0],ambientColor:16777215,ambientIntensity:1,lightIntensity:200,materialParams:{metalness:.5,roughness:.5,clearcoat:1,clearcoatRoughness:.15},minSize:.5,maxSize:1,size0:1,gravity:.5,friction:.9975,wallBounce:.95,maxVelocity:.15,maxX:5,maxY:5,maxZ:2,controlSphere0:!1,followCursor:!0},l=new bt;let c=!1;const h=new $e,d=new Map;function f(fe){const S={position:new $e,nPosition:new $e,hover:!1,onEnter:()=>{},onMove:()=>{},onClick:()=>{},onLeave:()=>{},...fe};return d.has(fe.domElement)||(d.set(fe.domElement,S),c||(document.body.addEventListener("pointermove",p),document.body.addEventListener("pointerleave",M),document.body.addEventListener("click",_),c=!0)),S.dispose=()=>{d.delete(fe.domElement),d.size===0&&(document.body.removeEventListener("pointermove",p),document.body.removeEventListener("pointerleave",M),document.body.removeEventListener("click",_),c=!1)},S}function p(fe){h.set(fe.clientX,fe.clientY);for(const[S,X]of d){const ie=S.getBoundingClientRect();u(ie)?(m(X,ie),X.hover||(X.hover=!0,X.onEnter(X)),X.onMove(X)):X.hover&&(X.hover=!1,X.onLeave(X))}}function _(fe){h.set(fe.clientX,fe.clientY);for(const[S,X]of d){const ie=S.getBoundingClientRect();m(X,ie),u(ie)&&X.onClick(X)}}function M(){for(const fe of d.values())fe.hover&&(fe.hover=!1,fe.onLeave(fe))}function m(fe,S){fe.position.set(h.x-S.left,h.y-S.top),fe.nPosition.set(fe.position.x/S.width*2-1,-fe.position.y/S.height*2+1)}function u(fe){return h.x>=fe.left&&h.x<=fe.left+fe.width&&h.y>=fe.top&&h.y<=fe.top+fe.height}class R extends dl{constructor(X,ie={}){const Me={...a,...ie},ae=new vm,me=new aa(X).fromScene(ae).texture,ve=new ba,qe=new o({envMap:me,...Me.materialParams});qe.envMapRotation.x=-Math.PI/2;super(ve,qe,Me.count);Ut(this,it);this.config=Me,this.physics=new s(Me),ft(this,it,Pl).call(this),this.setColors(Me.colors)}setColors(X){if(Array.isArray(X)&&X.length>1){const ie=function(Me){let ae=Me,Ie=[];return ae.forEach(me=>{Ie.push(new je(me))}),{setColors:me=>{ae=me,Ie=[],ae.forEach(ve=>{Ie.push(new je(ve))})},getColorAt:(me,ve=new je)=>{const y=Math.max(0,Math.min(1,me))*(ae.length-1),g=Math.floor(y),F=Ie[g];if(g>=ae.length-1)return F.clone();const q=y-g,K=Ie[g+1];return ve.r=F.r+q*(K.r-F.r),ve.g=F.g+q*(K.g-F.g),ve.b=F.b+q*(K.b-F.b),ve}}}(X);for(let Me=0;Me<this.count;Me++)this.setColorAt(Me,ie.getColorAt(Me/this.count)),Me===0&&this.light.color.copy(ie.getColorAt(Me/this.count));if(!this.instanceColor)return;this.instanceColor.needsUpdate=!0}}update(X){this.physics.update(X);for(let ie=0;ie<this.count;ie++)l.position.fromArray(this.physics.positionData,3*ie),ie===0&&this.config.followCursor===!1?l.scale.setScalar(0):l.scale.setScalar(this.physics.sizeData[ie]),l.updateMatrix(),this.setMatrixAt(ie,l.matrix),ie===0&&this.light.position.copy(l.position);this.instanceMatrix.needsUpdate=!0}}it=new WeakSet,Pl=function(){this.ambientLight=new Ph(this.config.ambientColor,this.config.ambientIntensity),this.add(this.ambientLight),this.light=new ml(this.config.colors[0],this.config.lightIntensity),this.add(this.light)};function b(fe,S={}){const X=new r({canvas:fe,size:"parent",rendererOptions:{antialias:!0,alpha:!0}});let ie;X.renderer.toneMapping=Xo,X.camera.position.set(0,0,20),X.camera.lookAt(0,0,0),X.cameraMaxAspect=1.5,X.resize(),qe(S);const Me=new Uh,ae=new wn(new I(0,0,1),0),Ie=new I;let me=!1;const ve=f({domElement:fe,onMove(){Me.setFromCamera(ve.nPosition,X.camera),X.camera.getWorldDirection(ae.normal),Me.ray.intersectPlane(ae,Ie),ie.physics.center.copy(Ie),ie.config.controlSphere0=!0},onLeave(){ie.config.controlSphere0=!1}});function qe(y){ie&&(X.clear(),X.scene.remove(ie)),ie=new R(X.renderer,y),X.scene.add(ie)}return X.onBeforeRender=y=>{me||ie.update(y)},X.onAfterResize=y=>{ie.config.maxX=y.wWidth/2,ie.config.maxY=y.wHeight/2},{three:X,get spheres(){return ie},setCount(y){qe({...ie.config,count:y})},togglePause(){me=!me},dispose(){var y;(y=ve.dispose)==null||y.call(ve),X.dispose()}}}return vn(()=>{const fe=t.value;if(!fe)return;const{followCursor:S,...X}=e,ie={metalness:e.materialParams.metalness??.5,roughness:e.materialParams.roughness??.5,clearcoat:e.materialParams.clearcoat??1,clearcoatRoughness:e.materialParams.clearcoatRoughness??.15};n.value=b(fe,{...X,followCursor:S,materialParams:ie})}),xn(()=>{n.value&&n.value.dispose()}),(fe,S)=>(ze(),ke("canvas",{ref_key:"canvasRef",ref:t,class:zi(["w-full","h-full",e.className])},null,2))}}),Mm={class:"grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center"},Sm={class:"lg:col-span-7 xl:col-span-8"},Em={class:"text-xs font-bold uppercase tracking-[0.3em] text-vermillion animate-fade-in mb-6"},ym={class:"font-serif text-display-xl text-charcoal animate-reveal-up dark:text-cream-100"},Tm={class:"mt-8 max-w-lg text-lg leading-relaxed text-charcoal-400 animate-reveal-up dark:text-charcoal-300",style:{"animation-delay":"0.15s"}},Am={class:"mt-10 flex flex-wrap items-center gap-4 animate-reveal-up",style:{"animation-delay":"0.25s"}},bm={href:"/cv.pdf",download:"",class:"btn-secondary"},wm={class:"lg:col-span-5 xl:col-span-4 flex justify-center lg:justify-end animate-fade-in",style:{"animation-delay":"0.3s"}},Rm={class:"relative"},Cm=["src","alt"],Pm={__name:"HeroSection",setup(i){Ge.registerPlugin(jn);const{t:e}=Zn(),t=Bl(),n=at(null),r=at(null),s=at(null),o=at(null);let a;const l=da(()=>t.isDark?[16731392,14697472,9150076]:[16731392,16742195,9150076]);return vn(()=>{a=Ge.context(()=>{Ge.to(r.value,{scrollTrigger:{trigger:n.value,start:"top top",end:"bottom top",scrub:!0},y:-120,opacity:0,scale:.95,ease:"none"}),Ge.to(s.value,{scrollTrigger:{trigger:n.value,start:"top top",end:"bottom top",scrub:!0},y:200,scale:1.1,ease:"none"}),Ge.to(o.value,{scrollTrigger:{trigger:n.value,start:"top top",end:"10% top",scrub:!0},opacity:0,y:-20,ease:"none"})},n.value)}),xn(()=>{a==null||a.revert()}),(c,h)=>{const d=zl("router-link");return ze(),ke("section",{ref_key:"sectionRef",ref:n,class:"relative min-h-screen flex items-center overflow-hidden bg-cream-50 dark:bg-charcoal-900"},[B("div",{ref_key:"bgRef",ref:s,class:"absolute inset-0 z-0 will-change-transform","aria-hidden":"true"},[en(xm,{count:60,colors:l.value,"ambient-color":ce(t).isDark?855309:16645370,"ambient-intensity":.5,"light-intensity":100,"min-size":.5,"max-size":1.4,gravity:.2,friction:.99,"wall-bounce":.9,"max-velocity":.08,"follow-cursor":!1,"material-params":{metalness:.2,roughness:.7,clearcoat:.8,clearcoatRoughness:.2},class:"h-full w-full opacity-25 dark:opacity-20"},null,8,["colors","ambient-color"])],512),B("div",{ref_key:"contentRef",ref:r,class:"section-container relative z-10 py-32 will-change-transform"},[B("div",Mm,[B("div",Sm,[B("p",Em,be(ce(e)("hero.role")),1),B("h1",ym,be(ce(Jt).name),1),h[2]||(h[2]=B("div",{class:"accent-line mt-8 animate-reveal-up",style:{"animation-delay":"0.1s"}},null,-1)),B("p",Tm,be(ce(e)("hero.shortBio")),1),B("div",Am,[en(d,{to:"/projects",class:"btn-primary"},{default:kl(()=>[Fa(be(ce(e)("hero.viewProjects"))+" ",1),h[0]||(h[0]=B("svg",{class:"h-4 w-4",fill:"none",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor"},[B("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"})],-1))]),_:1}),B("a",bm,[h[1]||(h[1]=B("svg",{class:"h-4 w-4",fill:"none",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor"},[B("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3"})],-1)),Fa(" "+be(ce(e)("hero.downloadCv")),1)])])]),B("div",wm,[B("div",Rm,[h[3]||(h[3]=B("div",{class:"absolute -inset-4 bg-vermillion/10 -rotate-3 dark:bg-vermillion/5","aria-hidden":"true"},null,-1)),B("img",{src:ce(Jt).photo,alt:`Photo of ${ce(Jt).name}`,class:"relative h-72 w-72 sm:h-80 sm:w-80 lg:h-96 lg:w-96 object-cover grayscale hover:grayscale-0 transition-all duration-700",loading:"eager"},null,8,Cm),h[4]||(h[4]=B("div",{class:"absolute -bottom-3 -right-3 w-24 h-24 border-2 border-vermillion","aria-hidden":"true"},null,-1))])])])],512),B("div",{ref_key:"scrollHintRef",ref:o,class:"absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 animate-fade-in",style:{"animation-delay":"1.2s"}},[...h[5]||(h[5]=[B("span",{class:"text-[10px] font-bold uppercase tracking-[0.3em] text-charcoal-300 dark:text-charcoal-500"},"Scroll",-1),B("div",{class:"h-12 w-px bg-charcoal-100 dark:bg-charcoal-700 relative overflow-hidden"},[B("div",{class:"absolute inset-x-0 top-0 h-3 bg-vermillion animate-scroll-line"})],-1)])],512)],512)}}},Dm={class:"section-container"},Lm={class:"grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start"},Um={class:"lg:col-span-4"},Im={class:"lg:col-span-8 min-w-0"},Nm={__name:"AboutSection",setup(i){Ge.registerPlugin(jn);const{t:e,locale:t}=Zn(),n=at(null),r=at(null),s=at(null),o=at(null);let a;const l=da(()=>e("about.bio").split(/\s+/));function c(){a==null||a.revert(),Vl(()=>{a=Ge.context(()=>{var d;Ge.from(r.value,{scrollTrigger:{trigger:n.value,start:"top 80%",toggleActions:"play none none none"},y:50,opacity:0,duration:.9,ease:"power3.out"}),Ge.from(s.value,{scrollTrigger:{trigger:n.value,start:"top 75%",toggleActions:"play none none none"},scaleX:0,transformOrigin:"left center",duration:.8,delay:.2,ease:"power3.out"});const h=(d=o.value)==null?void 0:d.querySelectorAll(".scroll-word");h!=null&&h.length&&(Ge.set(h,{opacity:.12}),Ge.to(h,{scrollTrigger:{trigger:o.value,start:"top 70%",end:"bottom 40%",scrub:!0},opacity:1,stagger:.05,ease:"none"}))},n.value)})}return vn(c),Hl(t,c),xn(()=>a==null?void 0:a.revert()),(h,d)=>(ze(),ke("section",{ref_key:"sectionRef",ref:n,id:"about",class:"py-32 lg:py-40 overflow-hidden"},[B("div",Dm,[B("div",Lm,[B("div",Um,[B("h2",{ref_key:"titleRef",ref:r,class:"section-title"},be(ce(e)("about.title")),513),B("div",{ref_key:"lineRef",ref:s,class:"accent-line mt-6"},null,512)]),B("div",Im,[B("p",{ref_key:"textRef",ref:o,class:"text-lg sm:text-xl lg:text-2xl leading-relaxed sm:leading-relaxed lg:leading-[1.8] text-charcoal-500 dark:text-charcoal-300 font-serif italic break-words overflow-wrap-anywhere"},[(ze(!0),ke(Bt,null,zt(l.value,(f,p)=>(ze(),ke("span",{key:`${ce(t)}-${p}`,class:"scroll-word"},be(f),1))),128))],512)])])])],512))}},Fm=Vo(Nm,[["__scopeId","data-v-766edb24"]]),Om={class:"shrink-0 py-24 lg:py-0 lg:w-[40vw] lg:min-w-[480px] lg:flex lg:items-center px-6 sm:px-8 lg:px-16 xl:px-24"},Bm={class:"text-xs font-bold uppercase tracking-[0.3em] text-vermillion mb-4"},zm={class:"font-serif text-display-md text-cream-100"},km={class:"mt-4 text-charcoal-300 max-w-md leading-relaxed"},Hm={class:"grid gap-px sm:grid-cols-2 lg:flex lg:gap-6 lg:pr-24 px-6 sm:px-8 lg:px-0 pb-24 lg:pb-0"},Vm={class:"text-[5rem] font-serif text-vermillion/15 leading-none mb-2 hidden lg:block select-none"},Gm=["innerHTML"],Wm={class:"font-serif text-xl lg:text-2xl text-cream-100"},Xm={class:"mt-3 text-sm lg:text-base leading-relaxed text-charcoal-300"},qm={__name:"InterestsSection",setup(i){Ge.registerPlugin(jn);const{t:e}=Zn(),t=at(null),n=at(null);let r;const s={strategy:'<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5m.75-9l3-3 2.148 2.148A12.061 12.061 0 0116.5 7.605" />',transform:'<path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.455 2.456L21.75 6l-1.036.259a3.375 3.375 0 00-2.455 2.456z" />',agile:'<path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182" />',data:'<path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />'};return vn(()=>{r=Ge.context(()=>{const o=Ge.matchMedia();o.add("(min-width: 1024px)",()=>{const a=n.value,l=a.scrollWidth-window.innerWidth;Ge.to(a,{x:()=>-(a.scrollWidth-window.innerWidth),ease:"none",scrollTrigger:{trigger:t.value,start:"top top",end:()=>`+=${l}`,pin:!0,scrub:1,invalidateOnRefresh:!0,anticipatePin:1}}),a.querySelectorAll(".interest-card").forEach(h=>{var d,f;Ge.from(h,{y:40,opacity:0,duration:.6,ease:"power2.out",scrollTrigger:{trigger:h,start:"left 85%",toggleActions:"play none none none",containerAnimation:((f=(d=Ge).getById)==null?void 0:f.call(d,"hScroll"))||void 0}})})}),o.add("(max-width: 1023px)",()=>{const a=t.value.querySelectorAll(".interest-card");Ge.from(a,{scrollTrigger:{trigger:t.value,start:"top 75%",toggleActions:"play none none none"},y:60,opacity:0,stagger:.15,duration:.8,ease:"power3.out"})})},t.value)}),xn(()=>{r==null||r.revert()}),(o,a)=>(ze(),ke("section",{ref_key:"sectionRef",ref:t,id:"interests",class:"bg-charcoal text-cream-100 dark:bg-charcoal-800 overflow-hidden"},[B("div",{ref_key:"trackRef",ref:n,class:"lg:flex lg:items-center lg:h-screen"},[B("div",Om,[B("div",null,[B("p",Bm,be(String(ce(Jt).interestIds.length).padStart(2,"0"))+" Areas",1),B("h2",zm,be(ce(e)("interests.title")),1),B("p",km,be(ce(e)("interests.subtitle")),1),a[0]||(a[0]=B("div",{class:"accent-line mt-8"},null,-1))])]),B("div",Hm,[(ze(!0),ke(Bt,null,zt(ce(Jt).interestIds,(l,c)=>(ze(),ke("div",{key:l,class:"interest-card group p-8 lg:p-10 transition-all duration-500 hover:bg-vermillion/10 lg:shrink-0 lg:w-[28vw] lg:min-w-[340px] lg:min-h-[55vh] lg:flex lg:flex-col lg:justify-center border border-charcoal-600"},[B("span",Vm,"0"+be(c+1),1),(ze(),ke("svg",{class:"h-8 w-8 text-vermillion mb-6 transition-transform duration-500 group-hover:scale-110",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor",innerHTML:s[l]},null,8,Gm)),B("h3",Wm,be(ce(e)(`interests.items.${l}.title`)),1),B("p",Xm,be(ce(e)(`interests.items.${l}.description`)),1)]))),128))])],512)],512))}},Ym={class:"section-container"},Km={class:"grid grid-cols-1 lg:grid-cols-12 gap-12"},jm={class:"section-title"},Zm={class:"space-y-0"},Jm={class:"flex items-start justify-between gap-4"},$m={class:"font-serif text-2xl text-charcoal dark:text-cream-100"},Qm={class:"mt-2 text-sm font-bold uppercase tracking-widest text-vermillion"},eg={class:"flex-shrink-0 text-xs font-bold uppercase tracking-widest text-charcoal-300 dark:text-charcoal-400 mt-2"},tg={class:"mt-4 text-sm leading-relaxed text-charcoal-400 dark:text-charcoal-300"},ng={__name:"EducationSection",setup(i){Ge.registerPlugin(jn);const{t:e}=Zn(),t=at(null),n=at(null),r=at(null);let s;return vn(()=>{s=Ge.context(()=>{Ge.from(n.value,{scrollTrigger:{trigger:t.value,start:"top 80%",toggleActions:"play none none none"},x:-80,opacity:0,duration:1,ease:"power3.out"}),Ge.from(r.value,{scrollTrigger:{trigger:t.value,start:"top 80%",toggleActions:"play none none none"},x:80,opacity:0,duration:1,delay:.15,ease:"power3.out"})},t.value)}),xn(()=>{s==null||s.revert()}),(o,a)=>(ze(),ke("section",{ref_key:"sectionRef",ref:t,id:"education",class:"py-24 lg:py-32 overflow-hidden"},[B("div",Ym,[B("div",Km,[B("div",{ref_key:"leftColRef",ref:n,class:"lg:col-span-4"},[B("h2",jm,be(ce(e)("education.title")),1),a[0]||(a[0]=B("div",{class:"accent-line mt-6"},null,-1))],512),B("div",{ref_key:"rightColRef",ref:r,class:"lg:col-span-8"},[B("div",Zm,[(ze(!0),ke(Bt,null,zt(ce(Jt).educationIds,l=>(ze(),ke("div",{key:l,class:"group border-b border-charcoal-100 py-8 first:pt-0 last:border-b-0 dark:border-charcoal-700"},[B("div",Jm,[B("div",null,[B("h3",$m,be(ce(e)(`education.items.${l}.degree`)),1),B("p",Qm,be(ce(e)(`education.items.${l}.institution`)),1)]),B("span",eg,be(ce(Jt).educationPeriods[l]),1)]),B("p",tg,be(ce(e)(`education.items.${l}.description`)),1)]))),128))])],512)])])],512))}},ig="data:image/png;base64,",rg="/assets/cmpl-Bg5Vbfhj.png",sg="data:image/png;base64,",ag="data:image/png;base64,",_s=[{id:"foco-criativo",logo:ig,positions:[{id:"product-manager",period:"Nov 2025 – Present",skills:["Product Management","Product Strategy","Wireframing","Jira","UX Design","Generative AI","AI","Backlog Management","Prototyping","UI Design","Design Thinking","Git","Product Road Mapping","Cross-functional Collaborations","User Stories","Product Ownership","Stakeholder Management","Scrum","User Research"]},{id:"product-owner",period:"Nov 2024 – Nov 2025",skills:["Product Strategy","Wireframing","Jira","UX Design","Generative AI","AI","Backlog Management","Prototyping","UI Design","Design Thinking","Git","Product Road Mapping","Cross-functional Collaborations","User Stories","Product Ownership","Stakeholder Management","Scrum","User Research"]},{id:"software-engineer",period:"Jun 2024 – Nov 2024",skills:["CSS","UX Design","UI Design","Front-End Development","HTML5","React Native","JavaScript","Scrum"]},{id:"intern",period:"Jan 2024 – Jun 2024"}]},{id:"cmpl-lifeguard",logo:rg,positions:[{id:"lifeguard-cmpl",period:"Jun 2023 – Sep 2023"}]},{id:"diver-lifeguard",logo:sg,positions:[{id:"lifeguard-diver",period:"Jul 2022 – Sep 2022"}]},{id:"zara",logo:ag,positions:[{id:"cashier",period:"Jun 2022 – Jul 2022"}]}],og={class:"bg-cream-200/50 dark:bg-charcoal-800/50 py-24 lg:py-16"},lg={class:"section-title"},cg={class:"section-subtitle"},hg={class:"hidden lg:block"},ug={class:"sticky top-20 h-[calc(100vh-5rem)] z-[1] bg-cream-50 dark:bg-charcoal-900 overflow-hidden shadow-[0_4px_30px_rgba(0,0,0,0.06)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.3)]"},dg={class:"shrink-0 w-[38vw] h-full flex items-center px-12 xl:px-20"},fg=["src","alt"],pg={class:"font-serif text-display-sm text-charcoal dark:text-cream-100"},mg={class:"mt-2 text-xs font-bold uppercase tracking-widest text-charcoal-300 dark:text-charcoal-400"},gg={class:"mt-6 text-sm leading-relaxed text-charcoal-400 dark:text-charcoal-300 max-w-sm"},_g={class:"text-[4.5rem] font-serif text-vermillion/15 leading-none mb-2 select-none"},vg={class:"font-serif text-xl text-charcoal dark:text-cream-100"},xg={class:"mt-2 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs"},Mg={class:"font-bold uppercase tracking-widest text-vermillion"},Sg={class:"font-bold uppercase tracking-widest text-charcoal-300 dark:text-charcoal-400"},Eg={key:0,class:"mt-4 text-sm leading-relaxed text-charcoal-400 dark:text-charcoal-300 line-clamp-5"},yg={key:1,class:"mt-5 flex flex-wrap gap-1.5 max-h-24 overflow-hidden"},Tg={key:0,class:"badge text-[10px] text-vermillion border-vermillion/30"},Ag={class:"section-container"},bg={class:"grid grid-cols-12 gap-12 items-center"},wg={class:"col-span-4"},Rg=["src","alt"],Cg={class:"font-serif text-2xl text-charcoal dark:text-cream-100"},Pg={class:"mt-1 text-xs font-bold uppercase tracking-widest text-charcoal-300 dark:text-charcoal-400"},Dg={class:"col-span-8"},Lg={class:"font-serif text-xl text-charcoal dark:text-cream-100"},Ug={class:"mt-2 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs"},Ig={class:"font-bold uppercase tracking-widest text-vermillion"},Ng={class:"font-bold uppercase tracking-widest text-charcoal-300 dark:text-charcoal-400"},Fg={key:0,class:"mt-4 text-sm leading-relaxed text-charcoal-400 dark:text-charcoal-300 max-w-2xl"},Og={class:"lg:hidden bg-cream-200/50 dark:bg-charcoal-800/50"},Bg={class:"section-container py-8 pb-24"},zg={class:"flex items-center gap-5 py-6"},kg=["src","alt"],Hg={class:"font-serif text-2xl text-charcoal dark:text-cream-100"},Vg={class:"text-xs font-bold uppercase tracking-widest text-charcoal-300 dark:text-charcoal-400"},Gg={class:"pb-8 pl-4 sm:pl-20"},Wg={key:0,class:"absolute -left-[calc(2rem+5px)] top-1.5 h-2.5 w-2.5 bg-vermillion"},Xg={class:"font-serif text-lg text-charcoal dark:text-cream-100"},qg={class:"mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs"},Yg={class:"font-bold uppercase tracking-widest text-vermillion"},Kg={class:"font-bold uppercase tracking-widest text-charcoal-300 dark:text-charcoal-400"},jg={key:1,class:"mt-3 text-sm leading-relaxed text-charcoal-400 dark:text-charcoal-300"},Zg={key:2,class:"mt-4 flex flex-wrap gap-2"},Jg={__name:"ExperienceSection",setup(i){Ge.registerPlugin(jn);const{t:e,te:t}=Zn(),n=at(null),r=at(null),s=at(null),o=at(null);let a;const l=_s.find(d=>d.id==="foco-criativo"),c=_s.filter(d=>d.id!=="foco-criativo"),h=["bg-cream-100 dark:bg-charcoal-800","bg-cream-200/70 dark:bg-charcoal-800/70","bg-cream-100 dark:bg-charcoal-800"];return vn(()=>{a=Ge.context(()=>{var p;const d=Ge.matchMedia(),f=(p=r.value)==null?void 0:p.children;f!=null&&f.length&&Ge.from(f,{scrollTrigger:{trigger:r.value,start:"top 80%",toggleActions:"play none none none"},y:40,opacity:0,stagger:.12,duration:.8,ease:"power3.out"}),d.add("(min-width: 1024px)",()=>{var m;const _=o.value;if(!_)return;Ge.to(_,{x:()=>-(_.scrollWidth-window.innerWidth),ease:"none",scrollTrigger:{trigger:s.value,start:"top top",end:"bottom bottom",scrub:1,invalidateOnRefresh:!0}});const M=(m=n.value)==null?void 0:m.querySelectorAll(".other-company-card");M==null||M.forEach(u=>{Ge.from(u.querySelector(".card-inner"),{scrollTrigger:{trigger:u,start:"top 95%",toggleActions:"play none none none"},y:30,opacity:0,duration:.7,ease:"power3.out"})})}),d.add("(max-width: 1023px)",()=>{var M;const _=(M=n.value)==null?void 0:M.querySelectorAll(".company-card-mobile");_==null||_.forEach(m=>{Ge.from(m,{scrollTrigger:{trigger:m,start:"top 85%",toggleActions:"play none none none"},y:50,opacity:0,duration:.8,ease:"power3.out"})})})},n.value)}),xn(()=>{a==null||a.revert()}),(d,f)=>(ze(),ke("section",{ref_key:"sectionRef",ref:n,id:"experience",class:"relative"},[B("div",og,[B("div",{ref_key:"headerRef",ref:r,class:"section-container flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4"},[B("div",null,[B("h2",lg,be(ce(e)("experience.title")),1),B("p",cg,be(ce(e)("experience.subtitle")),1)]),f[0]||(f[0]=B("div",{class:"accent-line flex-shrink-0"},null,-1))],512)]),B("div",hg,[B("div",{ref_key:"fcContainerRef",ref:s,class:"h-[220vh]"},[B("div",ug,[B("div",{ref_key:"fcTrackRef",ref:o,class:"flex items-center h-full will-change-transform"},[B("div",dg,[B("div",null,[B("img",{src:ce(l).logo,alt:ce(e)(`experience.companies.${ce(l).id}.name`),class:"h-20 w-20 object-cover grayscale mb-8"},null,8,fg),B("h3",pg,be(ce(e)(`experience.companies.${ce(l).id}.name`)),1),B("p",mg,be(ce(e)(`experience.companies.${ce(l).id}.location`)),1),f[1]||(f[1]=B("div",{class:"accent-line mt-8"},null,-1)),B("p",gg,be(ce(l).positions.length)+" roles · "+be(ce(l).positions[ce(l).positions.length-1].period.split("–")[0].trim())+" – Present ",1)])]),(ze(!0),ke(Bt,null,zt(ce(l).positions,(p,_)=>{var M;return ze(),ke("div",{key:p.id,class:"shrink-0 w-[30vw] min-w-[320px] h-[70vh] flex flex-col justify-center p-10 xl:p-12 border-l border-charcoal-100 dark:border-charcoal-700"},[B("span",_g,"0"+be(_+1),1),B("h4",vg,be(ce(e)(`experience.positions.${p.id}.title`)),1),B("div",xg,[B("span",Mg,be(ce(e)(`experience.positions.${p.id}.type`)),1),f[2]||(f[2]=B("span",{class:"text-charcoal-200 dark:text-charcoal-600"},"/",-1)),B("span",Sg,be(p.period),1)]),ce(t)(`experience.positions.${p.id}.description`)?(ze(),ke("p",Eg,be(ce(e)(`experience.positions.${p.id}.description`)),1)):bn("",!0),(M=p.skills)!=null&&M.length?(ze(),ke("div",yg,[(ze(!0),ke(Bt,null,zt(p.skills.slice(0,10),m=>(ze(),ke("span",{key:m,class:"badge text-[10px]"},be(m),1))),128)),p.skills.length>10?(ze(),ke("span",Tg," +"+be(p.skills.length-10),1)):bn("",!0)])):bn("",!0)])}),128))],512)])],512),(ze(!0),ke(Bt,null,zt(ce(c),(p,_)=>(ze(),ke("div",{key:p.id,class:"other-company-card h-[75vh]"},[B("div",{class:zi(["card-inner sticky top-20 h-[calc(75vh-5rem)] overflow-hidden flex items-center shadow-[0_-4px_30px_rgba(0,0,0,0.08)] dark:shadow-[0_-4px_30px_rgba(0,0,0,0.3)]",h[_%h.length]]),style:Pr({zIndex:_+2})},[B("div",Ag,[B("div",bg,[B("div",wg,[B("img",{src:p.logo,alt:ce(e)(`experience.companies.${p.id}.name`),class:"h-16 w-16 object-cover grayscale mb-6"},null,8,Rg),B("h3",Cg,be(ce(e)(`experience.companies.${p.id}.name`)),1),B("p",Pg,be(ce(e)(`experience.companies.${p.id}.location`)),1),f[3]||(f[3]=B("div",{class:"accent-line mt-6"},null,-1))]),B("div",Dg,[(ze(!0),ke(Bt,null,zt(p.positions,M=>(ze(),ke("div",{key:M.id},[B("h4",Lg,be(ce(e)(`experience.positions.${M.id}.title`)),1),B("div",Ug,[B("span",Ig,be(ce(e)(`experience.positions.${M.id}.type`)),1),f[4]||(f[4]=B("span",{class:"text-charcoal-200 dark:text-charcoal-600"},"/",-1)),B("span",Ng,be(M.period),1)]),ce(t)(`experience.positions.${M.id}.description`)?(ze(),ke("p",Fg,be(ce(e)(`experience.positions.${M.id}.description`)),1)):bn("",!0)]))),128))])])])],6)]))),128))]),B("div",Og,[B("div",Bg,[(ze(!0),ke(Bt,null,zt(ce(_s),p=>(ze(),ke("div",{key:p.id,class:"company-card-mobile border-b border-charcoal-100 dark:border-charcoal-700 last:border-b-0"},[B("div",zg,[B("img",{src:p.logo,alt:ce(e)(`experience.companies.${p.id}.name`),class:"h-14 w-14 flex-shrink-0 object-cover grayscale"},null,8,kg),B("div",null,[B("h3",Hg,be(ce(e)(`experience.companies.${p.id}.name`)),1),B("p",Vg,be(ce(e)(`experience.companies.${p.id}.location`)),1)])]),B("div",Gg,[B("div",{class:zi(["relative",p.positions.length>1?"border-l-2 border-vermillion/30 pl-8":""])},[(ze(!0),ke(Bt,null,zt(p.positions,(_,M)=>{var m;return ze(),ke("div",{key:_.id,class:zi(["relative",M<p.positions.length-1?"mb-8 pb-8 border-b border-charcoal-50 dark:border-charcoal-700/50":""])},[p.positions.length>1?(ze(),ke("div",Wg)):bn("",!0),B("h4",Xg,be(ce(e)(`experience.positions.${_.id}.title`)),1),B("div",qg,[B("span",Yg,be(ce(e)(`experience.positions.${_.id}.type`)),1),f[5]||(f[5]=B("span",{class:"text-charcoal-200 dark:text-charcoal-600"},"/",-1)),B("span",Kg,be(_.period),1)]),ce(t)(`experience.positions.${_.id}.description`)?(ze(),ke("p",jg,be(ce(e)(`experience.positions.${_.id}.description`)),1)):bn("",!0),(m=_.skills)!=null&&m.length?(ze(),ke("div",Zg,[(ze(!0),ke(Bt,null,zt(_.skills,u=>(ze(),ke("span",{key:u,class:"badge"},be(u),1))),128))])):bn("",!0)],2)}),128))],2)])]))),128))])])],512))}},$g=[{id:"productStrategy",rating:5},{id:"agileScrum",rating:4},{id:"dataAnalysis",rating:4},{id:"stakeholderManagement",rating:5},{id:"userResearch",rating:4}],Qg=["roadmapPlanning","abTesting","sql","jiraConfluence","figma","wireframing","marketAnalysis","okrsKpis","apiDesign","businessModeling","presentationDesign","crossFunctionalLeadership"],e_=[{id:"portuguese",percentage:100},{id:"english",percentage:90}],t_={class:"section-container"},n_={class:"grid grid-cols-1 lg:grid-cols-12 gap-12"},i_={class:"lg:col-span-4"},r_={class:"lg:col-span-8 space-y-16"},s_={class:"font-serif text-xl text-charcoal dark:text-cream-100 mb-8"},a_={class:"space-y-6"},o_={class:"skill-label flex items-center justify-between mb-2"},l_={class:"text-sm font-bold uppercase tracking-widest text-charcoal-500 dark:text-charcoal-300"},c_={class:"text-xs text-charcoal-300 dark:text-charcoal-400"},h_={class:"h-1 bg-charcoal-100 dark:bg-charcoal-700 overflow-hidden"},u_=["aria-valuenow"],d_={class:"font-serif text-xl text-charcoal dark:text-cream-100 mb-6"},f_={class:"flex flex-wrap gap-2"},p_={class:"font-serif text-xl text-charcoal dark:text-cream-100 mb-8"},m_={class:"space-y-6"},g_={class:"flex items-baseline justify-between mb-2"},__={class:"text-sm font-bold uppercase tracking-widest text-charcoal-500 dark:text-charcoal-300"},v_={class:"text-xs text-charcoal-300 dark:text-charcoal-400"},x_={class:"h-1 bg-charcoal-100 dark:bg-charcoal-700 overflow-hidden"},M_=["aria-valuenow"],S_={__name:"SkillsSection",setup(i){Ge.registerPlugin(jn);const{t:e}=Zn(),t=at(null),n=at(null),r=at(null),s=at(null),o=at(null),a=at(null),l=at(null);let c;return vn(()=>{c=Ge.context(()=>{var _,M,m,u;Ge.from(n.value,{scrollTrigger:{trigger:t.value,start:"top 80%",toggleActions:"play none none none"},y:50,opacity:0,duration:.9,ease:"power3.out"}),Ge.from(r.value,{scrollTrigger:{trigger:t.value,start:"top 75%",toggleActions:"play none none none"},y:30,opacity:0,duration:.7,delay:.15,ease:"power3.out"}),Ge.from(s.value,{scrollTrigger:{trigger:t.value,start:"top 75%",toggleActions:"play none none none"},scaleX:0,transformOrigin:"left center",duration:.8,delay:.25,ease:"power3.out"});const h=(_=o.value)==null?void 0:_.querySelectorAll(".skill-bar-fill");h!=null&&h.length&&Ge.from(h,{scrollTrigger:{trigger:o.value,start:"top 80%",toggleActions:"play none none none"},scaleX:0,transformOrigin:"left center",stagger:.12,duration:1.2,ease:"power2.out"});const d=(M=o.value)==null?void 0:M.querySelectorAll(".skill-label");d!=null&&d.length&&Ge.from(d,{scrollTrigger:{trigger:o.value,start:"top 80%",toggleActions:"play none none none"},x:-20,opacity:0,stagger:.1,duration:.6,ease:"power3.out"});const f=(m=a.value)==null?void 0:m.querySelectorAll(".badge");f!=null&&f.length&&Ge.from(f,{scrollTrigger:{trigger:a.value,start:"top 85%",toggleActions:"play none none none"},scale:.7,opacity:0,stagger:.03,duration:.4,ease:"back.out(2)"});const p=(u=l.value)==null?void 0:u.querySelectorAll(".lang-bar-fill");p!=null&&p.length&&Ge.from(p,{scrollTrigger:{trigger:l.value,start:"top 85%",toggleActions:"play none none none"},scaleX:0,transformOrigin:"left center",stagger:.15,duration:1,ease:"power2.out"})},t.value)}),xn(()=>{c==null||c.revert()}),(h,d)=>(ze(),ke("section",{ref_key:"sectionRef",ref:t,id:"skills",class:"py-24 lg:py-32"},[B("div",t_,[B("div",n_,[B("div",i_,[B("h2",{ref_key:"titleRef",ref:n,class:"section-title"},be(ce(e)("skills.title")),513),B("p",{ref_key:"subtitleRef",ref:r,class:"section-subtitle"},be(ce(e)("skills.subtitle")),513),B("div",{ref_key:"lineRef",ref:s,class:"accent-line mt-6"},null,512)]),B("div",r_,[B("div",{ref_key:"topSkillsRef",ref:o},[B("h3",s_,be(ce(e)("skills.topTitle")),1),B("div",a_,[(ze(!0),ke(Bt,null,zt(ce($g),f=>(ze(),ke("div",{key:f.id,class:"group"},[B("div",o_,[B("span",l_,be(ce(e)(`skills.top.${f.id}`)),1),B("span",c_,be(f.rating)+"/5",1)]),B("div",h_,[B("div",{class:"skill-bar-fill h-full bg-vermillion",style:Pr({width:f.rating/5*100+"%"}),role:"progressbar","aria-valuenow":f.rating,"aria-valuemin":"0","aria-valuemax":"5"},null,12,u_)])]))),128))])],512),B("div",{ref_key:"otherSkillsRef",ref:a},[B("h3",d_,be(ce(e)("skills.otherTitle")),1),B("div",f_,[(ze(!0),ke(Bt,null,zt(ce(Qg),f=>(ze(),ke("span",{key:f,class:"badge"},be(ce(e)(`skills.other.${f}`)),1))),128))])],512),B("div",{ref_key:"languagesRef",ref:l},[B("h3",p_,be(ce(e)("skills.langTitle")),1),B("div",m_,[(ze(!0),ke(Bt,null,zt(ce(e_),f=>(ze(),ke("div",{key:f.id},[B("div",g_,[B("span",__,be(ce(e)(`skills.languages.${f.id}.name`)),1),B("span",v_,be(ce(e)(`skills.languages.${f.id}.level`)),1)]),B("div",x_,[B("div",{class:"lang-bar-fill h-full bg-sage",style:Pr({width:f.percentage+"%"}),role:"progressbar","aria-valuenow":f.percentage,"aria-valuemin":"0","aria-valuemax":"100"},null,12,M_)])]))),128))])],512)])])])],512))}},E_={class:"pc-inside"},y_={class:"pc-content pc-avatar-content"},T_=["src","alt"],A_={key:0,class:"pc-user-info"},b_={class:"pc-user-details"},w_={class:"pc-mini-avatar"},R_=["src","alt"],C_={class:"pc-user-text"},P_={class:"pc-handle"},D_={class:"pc-status"},L_=["aria-label"],U_={class:"pc-content"},I_={class:"pc-details"},N_="radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(16,100%,85%,var(--card-opacity)) 4%,hsla(16,60%,70%,calc(var(--card-opacity)*0.75)) 10%,hsla(16,30%,60%,calc(var(--card-opacity)*0.5)) 50%,hsla(16,0%,50%,0) 100%),radial-gradient(35% 52% at 55% 20%,#8b9e7cc4 0%,#1a1a1a00 100%),radial-gradient(100% 100% at 50% 50%,#ff4d00ff 1%,#1a1a1a00 76%),conic-gradient(from 124deg at 50% 50%,#ff4d00ff 0%,#8b9e7cff 40%,#8b9e7cff 60%,#ff4d00ff 100%)",F_="linear-gradient(145deg,#1a1a1acc 0%,#ff4d0033 100%)",O_=Ho({__name:"ProfileCard",props:{avatarUrl:{default:"<Placeholder for avatar URL>"},iconUrl:{default:"<Placeholder for icon URL>"},grainUrl:{default:"<Placeholder for grain URL>"},behindGradient:{default:void 0},innerGradient:{default:void 0},showBehindGradient:{type:Boolean,default:!0},className:{default:""},enableTilt:{type:Boolean,default:!0},miniAvatarUrl:{default:void 0},name:{default:"Javi A. Torres"},title:{default:"Software Engineer"},handle:{default:"javicodes"},status:{default:"Online"},contactText:{default:"Contact"},showUserInfo:{type:Boolean,default:!0}},emits:["contactClick"],setup(i,{emit:e}){const t=i,n=e,r=vs("wrapRef"),s=vs("cardRef"),o={SMOOTH_DURATION:600,INITIAL_DURATION:1500,INITIAL_X_OFFSET:70,INITIAL_Y_OFFSET:60},a=(A,w=0,D=100)=>Math.min(Math.max(A,w),D),l=(A,w=3)=>parseFloat(A.toFixed(w)),c=(A,w,D,E,x)=>l(E+(x-E)*(A-w)/(D-w)),h=A=>A<.5?4*A*A*A:1-Math.pow(-2*A+2,3)/2;let d=null;const f=(A,w,D,E)=>{const x=D.clientWidth,C=D.clientHeight,W=a(100/x*A),z=a(100/C*w),O=W-50,$=z-50,Y={"--pointer-x":`${W}%`,"--pointer-y":`${z}%`,"--background-x":`${c(W,0,100,35,65)}%`,"--background-y":`${c(z,0,100,35,65)}%`,"--pointer-from-center":`${a(Math.hypot(z-50,W-50)/50,0,1)}`,"--pointer-from-top":`${z/100}`,"--pointer-from-left":`${W/100}`,"--rotate-x":`${l(-(O/5))}deg`,"--rotate-y":`${l($/4)}deg`};Object.entries(Y).forEach(([ne,V])=>{E.style.setProperty(ne,V)})},p=(A,w,D,E,x)=>{const C=performance.now(),W=x.clientWidth/2,z=x.clientHeight/2,O=$=>{const Y=$-C,ne=a(Y/A),V=h(ne),he=c(V,0,1,w,W),_e=c(V,0,1,D,z);f(he,_e,E,x),ne<1&&(d=requestAnimationFrame(O))};d=requestAnimationFrame(O)},_=()=>{d&&(cancelAnimationFrame(d),d=null)},M=A=>{const w=s.value,D=r.value;if(!w||!D||!t.enableTilt)return;const E=w.getBoundingClientRect();f(A.clientX-E.left,A.clientY-E.top,w,D)},m=()=>{const A=s.value,w=r.value;!A||!w||!t.enableTilt||(_(),w.classList.add("active"),A.classList.add("active"))},u=A=>{const w=s.value,D=r.value;!w||!D||!t.enableTilt||(p(o.SMOOTH_DURATION,A.offsetX,A.offsetY,w,D),D.classList.remove("active"),w.classList.remove("active"))},R=da(()=>({"--icon":t.iconUrl?`url(${t.iconUrl})`:"none","--grain":t.grainUrl?`url(${t.grainUrl})`:"none","--behind-gradient":t.showBehindGradient?t.behindGradient??N_:"none","--inner-gradient":t.innerGradient??F_})),b=()=>{n("contactClick")},T=A=>{const w=A.target;w.style.display="none"},U=A=>{const w=A.target;w.style.opacity="0.5",w.src=t.avatarUrl};return vn(()=>{if(!t.enableTilt)return;const A=s.value,w=r.value;if(!A||!w)return;A.addEventListener("pointerenter",m),A.addEventListener("pointermove",M),A.addEventListener("pointerleave",u);const D=w.clientWidth-o.INITIAL_X_OFFSET,E=o.INITIAL_Y_OFFSET;f(D,E,A,w),p(o.INITIAL_DURATION,D,E,A,w)}),xn(()=>{const A=s.value;A&&(A.removeEventListener("pointerenter",m),A.removeEventListener("pointermove",M),A.removeEventListener("pointerleave",u)),_()}),(A,w)=>(ze(),ke("div",{ref_key:"wrapRef",ref:r,class:zi(`pc-card-wrapper ${i.className}`.trim()),style:Pr(R.value)},[B("section",{ref_key:"cardRef",ref:s,class:"pc-card"},[B("div",E_,[w[0]||(w[0]=B("div",{class:"pc-shine"},null,-1)),w[1]||(w[1]=B("div",{class:"pc-glare"},null,-1)),B("div",y_,[B("img",{class:"avatar",src:i.avatarUrl,alt:`${i.name||"User"} avatar`,loading:"lazy",onError:T},null,40,T_),i.showUserInfo?(ze(),ke("div",A_,[B("div",b_,[B("div",w_,[B("img",{src:i.miniAvatarUrl||i.avatarUrl,alt:`${i.name||"User"} mini avatar`,loading:"lazy",onError:U},null,40,R_)]),B("div",C_,[B("div",P_,"@"+be(i.handle),1),B("div",D_,be(i.status),1)])]),B("button",{class:"pc-contact-btn",onClick:b,style:{"pointer-events":"auto"},type:"button","aria-label":`Contact ${i.name||"user"}`},be(i.contactText),9,L_)])):bn("",!0)]),B("div",U_,[B("div",I_,[B("h3",null,be(i.name),1),B("p",null,be(i.title),1)])])])],512)],6))}}),B_=Vo(O_,[["__scopeId","data-v-d4648820"]]),z_={class:"section-container"},k_={class:"section-title"},H_={class:"section-subtitle mx-auto"},V_={__name:"ContactSection",setup(i){Ge.registerPlugin(jn);const{t:e}=Zn(),t=at(null),n=at(null),r=at(null);let s;const o=()=>{window.location.href=`mailto:${Jt.email}`};return vn(()=>{s=Ge.context(()=>{var l;const a=(l=n.value)==null?void 0:l.children;a!=null&&a.length&&Ge.from(a,{scrollTrigger:{trigger:t.value,start:"top 80%",toggleActions:"play none none none"},y:40,opacity:0,stagger:.12,duration:.8,ease:"power3.out"}),Ge.from(r.value,{scrollTrigger:{trigger:r.value,start:"top 85%",toggleActions:"play none none none"},scale:.85,opacity:0,duration:1,delay:.2,ease:"power3.out"})},t.value)}),xn(()=>{s==null||s.revert()}),(a,l)=>(ze(),ke("section",{ref_key:"sectionRef",ref:t,id:"contact",class:"py-24 lg:py-32 bg-cream-200 dark:bg-charcoal-800"},[B("div",z_,[B("div",{ref_key:"headerRef",ref:n,class:"text-center mb-16"},[B("h2",k_,be(ce(e)("contact.title")),1),B("p",H_,be(ce(e)("contact.subtitle")),1),l[0]||(l[0]=B("div",{class:"accent-line mt-6 mx-auto"},null,-1))],512),B("div",{ref_key:"cardRef",ref:r,class:"flex justify-center"},[en(B_,{"avatar-url":ce(Jt).photo,"mini-avatar-url":ce(Jt).photo,name:ce(Jt).name,title:ce(e)("hero.role"),handle:"nunoamorim99",status:ce(e)("contact.status"),"contact-text":ce(e)("contact.button"),"show-user-info":!0,"enable-tilt":!0,onContactClick:o},null,8,["avatar-url","mini-avatar-url","name","title","status","contact-text"])],512)])],512))}},q_={__name:"HomePage",setup(i){return(e,t)=>(ze(),ke("div",null,[en(Pm),en(Fm),en(qm),en(ng),en(Jg),en(S_),en(V_)]))}};export{q_ as default};
